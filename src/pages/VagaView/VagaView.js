    ...
    <div className="container flex-grow-1">
      <div className="row">
        <div className="col">
          ...
          <h2 className="text-center">{vaga.genero}</h2> 
          <h4 className="text-center">{vaga.marca}</h4>
          <h5 className="text-center">{vaga.tamanho}</h5>
          <h5 className="text-center">{vaga.cor}</h5>
